...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}4}]:} <matplotlib.image.AxesImage at 0x7f97a902bef0>
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}5}]:} \PY{k}{for} \PY{n}{image} \PY{o+ow}{in} \PY{n}{IMAGE\PYZus{}LIST}\PY{p}{:}
            \PY{k}{if} \PY{n}{image}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]} \PY{o}{==} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{yellow}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}
                \PY{n+nb}{print}\PY{p}{(}\PY{n}{image}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{o}{.}\PY{n}{shape}\PY{p}{)}
                \PY{n}{plt}\PY{o}{.}\PY{n}{imshow}\PY{p}{(}\PY{n}{image}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{)}
                \PY{k}{break}
...
sent through the same pipeline of classification steps!
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}6}]:} \PY{c+c1}{\PYZsh{} This function should take in an RGB image and return a new, standardized version}
        \PY{k}{def} \PY{n+nf}{standardize\PYZus{}input}\PY{p}{(}\PY{n}{image}\PY{p}{)}\PY{p}{:}
            ...
            \PY{n}{standard\PYZus{}im} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{copy}\PY{p}{(}\PY{n}{image}\PY{p}{)}
            
            \PY{n}{height}\PY{p}{,} \PY{n}{width} \PY{o}{=} \PY{l+m+mi}{32}\PY{p}{,} \PY{l+m+mi}{32}
            \PY{n}{standard\PYZus{}im} \PY{o}{=} \PY{n}{cv2}\PY{o}{.}\PY{n}{resize}\PY{p}{(}\PY{n}{standard\PYZus{}im}\PY{p}{,}\PY{p}{(}\PY{n}{width}\PY{p}{,} \PY{n}{height}\PY{p}{)}\PY{p}{,} \PY{n}{interpolation} \PY{o}{=} \PY{n}{cv2}\PY{o}{.}\PY{n}{INTER\PYZus{}CUBIC}\PY{p}{)}
...
and change the middle value (the yellow value) to 1: {[}0, 1, 0{]}.
 ...
 \#\#\# (IMPLEMENTATION): Implement one-hot encoding
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}7}]:} \PY{c+c1}{\PYZsh{}\PYZsh{} TODO: One hot encode an image label}
...
failed. Once your code works, this should print out TEST PASSED.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}8}]:} \PY{c+c1}{\PYZsh{} Importing the tests}
...
work!
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}9}]:} \PY{k}{def} \PY{n+nf}{standardize}\PY{p}{(}\PY{n}{image\PYZus{}list}\PY{p}{)}\PY{p}{:}
...
{\color{incolor}In [{\color{incolor}10}]:} \PY{c+c1}{\PYZsh{}\PYZsh{} TODO: Display a standardized image and its label}
         ...
         \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Label [red, yellow, green]: }\PY{l+s+s1}{\PYZsq{}} \PY{o}{+} \PY{n+nb}{str}\PY{p}{(}\PY{n}{selected\PYZus{}label}\PY{p}{)}\PY{p}{)}
\end{Verbatim}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}11}]:} <matplotlib.image.AxesImage at 0x7f97a8d9b5c0>
\end{Verbatim}
...
also define helper functions if they simplify your code.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}12}]:} \PY{c+c1}{\PYZsh{}\PYZsh{} TODO: Create a brightness feature that takes in an RGB image and outputs a feature vector and/or value}
         ...
         \PY{k}{def} \PY{n+nf}{create\PYZus{}feature}\PY{p}{(}\PY{n}{rgb\PYZus{}image}\PY{p}{)}\PY{p}{:}
             ...
             \PY{c+c1}{\PYZsh{} red}
             \PY{n}{lower\PYZus{}range} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{p}{[}\PY{l+m+mi}{155}\PY{p}{,} \PY{l+m+mi}{80}\PY{p}{,} \PY{l+m+mi}{90}\PY{p}{]}\PY{p}{,} \PY{n}{dtype}\PY{o}{=}\PY{n}{np}\PY{o}{.}\PY{n}{uint8}\PY{p}{)}
             \PY{n}{upper\PYZus{}range} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{p}{[}\PY{l+m+mi}{190}\PY{p}{,} \PY{l+m+mi}{255}\PY{p}{,} \PY{l+m+mi}{255}\PY{p}{]}\PY{p}{,} \PY{n}{dtype}\PY{o}{=}\PY{n}{np}\PY{o}{.}\PY{n}{uint8}\PY{p}{)}
             \PY{n}{mask} \PY{o}{=} \PY{n}{cv2}\PY{o}{.}\PY{n}{inRange}\PY{p}{(}\PY{n}{hsv}\PY{p}{,} \PY{n}{lower\PYZus{}range}\PY{p}{,} \PY{n}{upper\PYZus{}range}\PY{p}{)}
             \PY{n}{total\PYZus{}red} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{sum}\PY{p}{(}\PY{n}{mask}\PY{p}{[}\PY{p}{:}\PY{p}{,}\PY{p}{:}\PY{p}{]}\PY{p}{)} \PY{o}{/}\PY{l+m+mi}{255}
             
             \PY{c+c1}{\PYZsh{} yellow}
             \PY{n}{lower\PYZus{}range} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{p}{[}\PY{l+m+mi}{20}\PY{p}{,}\PY{l+m+mi}{50}\PY{p}{,}\PY{l+m+mi}{50}\PY{p}{]}\PY{p}{,} \PY{n}{dtype}\PY{o}{=}\PY{n}{np}\PY{o}{.}\PY{n}{uint8}\PY{p}{)}
             \PY{n}{upper\PYZus{}range} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{p}{[}\PY{l+m+mi}{30}\PY{p}{,}\PY{l+m+mi}{255}\PY{p}{,}\PY{l+m+mi}{255}\PY{p}{]}\PY{p}{,} \PY{n}{dtype}\PY{o}{=}\PY{n}{np}\PY{o}{.}\PY{n}{uint8}\PY{p}{)}
             \PY{n}{mask} \PY{o}{=} \PY{n}{cv2}\PY{o}{.}\PY{n}{inRange}\PY{p}{(}\PY{n}{hsv}\PY{p}{,} \PY{n}{lower\PYZus{}range}\PY{p}{,} \PY{n}{upper\PYZus{}range}\PY{p}{)}
             \PY{n}{total\PYZus{}yellow} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{sum}\PY{p}{(}\PY{n}{mask}\PY{p}{[}\PY{p}{:}\PY{p}{,}\PY{p}{:}\PY{p}{]}\PY{p}{)} \PY{o}{/} \PY{l+m+mi}{255}
             
             \PY{c+c1}{\PYZsh{}green}
             \PY{n}{lower\PYZus{}range} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{p}{[}\PY{l+m+mi}{20}\PY{p}{,}\PY{l+m+mi}{30}\PY{p}{,}\PY{l+m+mi}{40}\PY{p}{]}\PY{p}{,} \PY{n}{dtype}\PY{o}{=}\PY{n}{np}\PY{o}{.}\PY{n}{uint8}\PY{p}{)}
             \PY{n}{upper\PYZus{}range} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{p}{[}\PY{l+m+mi}{90}\PY{p}{,}\PY{l+m+mi}{255}\PY{p}{,}\PY{l+m+mi}{230}\PY{p}{]}\PY{p}{,} \PY{n}{dtype}\PY{o}{=}\PY{n}{np}\PY{o}{.}\PY{n}{uint8}\PY{p}{)}
             \PY{n}{mask} \PY{o}{=} \PY{n}{cv2}\PY{o}{.}\PY{n}{inRange}\PY{p}{(}\PY{n}{hsv}\PY{p}{,} \PY{n}{lower\PYZus{}range}\PY{p}{,} \PY{n}{upper\PYZus{}range}\PY{p}{)}
             \PY{n}{total\PYZus{}green} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{sum}\PY{p}{(}\PY{n}{mask}\PY{p}{[}\PY{p}{:}\PY{p}{,}\PY{p}{:}\PY{p}{]}\PY{p}{)} \PY{o}{/} \PY{l+m+mi}{255}
             
             \PY{n}{feature} \PY{o}{=} \PY{n}{total\PYZus{}red}\PY{p}{,} \PY{n}{total\PYZus{}yellow}\PY{p}{,} \PY{n}{total\PYZus{}green}
...
images}\label{optional-create-more-features-to-help-accurately-label-the-traffic-light-images}}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}13}]:} \PY{c+c1}{\PYZsh{} (Optional) Add more image analysis and create more features}
\end{Verbatim}
...
The obtained characteristics are the amount of green, yellow and red
dots in the image. The color classified will be the one with the highest
number of dots.
...
\texttt{estimate\_label} function returns a one-hot encoded label.
 ...
 \#\#\# (IMPLEMENTATION): Build a complete classifier
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}14}]:} \PY{c+c1}{\PYZsh{} This function should take in RGB image input}
         ...
         \PY{k}{def} \PY{n+nf}{estimate\PYZus{}label}\PY{p}{(}\PY{n}{rgb\PYZus{}image}\PY{p}{)}\PY{p}{:}
             ...
             \PY{n}{total\PYZus{}red}\PY{p}{,} \PY{n}{total\PYZus{}yellow}\PY{p}{,} \PY{n}{total\PYZus{}green} \PY{o}{=} \PY{n}{create\PYZus{}feature}\PY{p}{(}\PY{n}{rgb\PYZus{}image}\PY{p}{)}
             \PY{n}{predicted\PYZus{}label} \PY{o}{=} \PY{p}{[}\PY{l+m+mi}{1}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{]}
             \PY{k}{if} \PY{n}{total\PYZus{}green} \PY{o}{\PYZgt{}} \PY{n}{total\PYZus{}red}\PY{p}{:}
                 \PY{n}{predicted\PYZus{}label} \PY{o}{=} \PY{p}{[}\PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{1}\PY{p}{]}
                 
             \PY{k}{if} \PY{n}{total\PYZus{}yellow} \PY{o}{\PYZgt{}} \PY{n}{total\PYZus{}red} \PY{o+ow}{and} \PY{n}{total\PYZus{}yellow} \PY{o}{\PYZgt{}} \PY{n}{total\PYZus{}green}\PY{p}{:}
...
testing accuracy.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}15}]:} \PY{c+c1}{\PYZsh{} Using the load\PYZus{}dataset function in helpers.py}
...
code is used for testing and \emph{should not be changed}.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}16}]:} \PY{c+c1}{\PYZsh{} Constructs a list of misclassified images given a list of test images and their labels}
...
your classification algorithm.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}20}]:} \PY{c+c1}{\PYZsh{} Visualize misclassified example(s)}
         ...
         \PY{n}{im\PYZus{}num} \PY{o}{=} \PY{l+m+mi}{1}
         \PY{n}{plt}\PY{o}{.}\PY{n}{imshow}\PY{p}{(}\PY{n}{MISCLASSIFIED}\PY{p}{[}\PY{n}{im\PYZus{}num}\PY{p}{]}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{)}
         \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Predicted Label: }\PY{l+s+s2}{\PYZdq{}} \PY{o}{+} \PY{n+nb}{str}\PY{p}{(}\PY{n}{MISCLASSIFIED}\PY{p}{[}\PY{n}{im\PYZus{}num}\PY{p}{]}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{)}\PY{p}{)}
         \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{True Label: }\PY{l+s+s2}{\PYZdq{}}\PY{o}{+} \PY{n+nb}{str}\PY{p}{(}\PY{n}{MISCLASSIFIED}\PY{p}{[}\PY{n}{im\PYZus{}num}\PY{p}{]}\PY{p}{[}\PY{l+m+mi}{2}\PY{p}{]}\PY{p}{)}\PY{p}{)}
\end{Verbatim}
...
Some images are classified wrong because the range of their HSV values
are compact with other label colors.

Images with poor quality often leave the expected HSV values for that
image.
...
lights have been mistakenly labelled {[}0, 1, 0{]} (green).
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}21}]:} \PY{c+c1}{\PYZsh{} Importing the tests}
         \PY{k+kn}{import} \PY{n+nn}{test\PYZus{}functions}
         \PY{n}{tests} \PY{o}{=} \PY{n}{test\PYZus{}functions}\PY{o}{.}\PY{n}{Tests}\PY{p}{(}\PY{p}{)}
